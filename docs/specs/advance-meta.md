...
- GitHub CI / check-run / status investigation routes to general for one-shot investigation and to adv-ci-waiter when the requested end-state requires waiting until terminal
- Release/archive PR pending checks after sign-off route to adv-ci-waiter
...
**Then:**
- The section includes operational delegation prose tokens including GitHub CI, check-run, reads/searches, second, general, and adv-ci-waiter
...
- The table contains a GitHub CI / check-run / status investigation row mapped to general for one-shot investigation and adv-ci-waiter for wait-to-terminal work
- The table contains a release/archive PR pending checks row mapped to adv-ci-waiter
