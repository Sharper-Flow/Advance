...
1. **Extract repo metadata** — Exa for candidate repos; searchcode file-tree, file-fetch, and repo-analysis capabilities for README, package manifests, main language
...
2. **Exa fallback** — Exa web search (standard or advanced) for recent news, reviews, comparisons
