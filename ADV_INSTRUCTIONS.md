...
| `/adv-backlog`  | Collaborative                | Capture future work as backlog-status changes before proposal; typed-tool mutation after confirmation                                                                                        |
...
| Architecture vocabulary skill         | `adv-design`, `adv-discover` → `adv-codebase-design`                                                                                                                                           | `orchestrator-only`         |
...
| Embedded methodology                  | `adv-discover`, `adv-prep`, `adv-apply`, `adv-review`, `adv-optimizer`; `adv-harden` keeps embedded harden guidance alongside shared `adv-slop-detection` scanner methodology                    | —                           |
