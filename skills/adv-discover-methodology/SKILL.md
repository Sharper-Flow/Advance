...
| 2 | **Prior Research Extension** | Extends | Cited artifacts + ≥1 new finding (or "No prior research found") |
...
| 8 | **LBP Check** | LBP Check | Whether the likely direction matches long-term best practice |
