...
- [ ] **Prior Research Extension** — Search `temp/*.md`, `docs/*-prep.md`, and archived changes for prior artifacts. Cite each in "Extends" section and add ≥1 new finding beyond what it contained.
...
- [ ] **LBP Check** — Verify the likely direction matches long-term best practice. Output: "LBP Check" section with direction and evidence.
...
| Prior Research | No prior artifacts exist | Report "No prior research found". Non-blocking. |
