...
const epicMergedSignal = wf.defineSignal<
  [import("../types").EpicMergedSignalPayload]
...
const changeRetargetedSignal = wf.defineSignal<
  [import("../types").ChangeRetargetedSignalPayload]
...
export async function epicWorkflow(input: EpicWorkflowInput): Promise<void> {
  ...
  wf.setHandler(
    epicMergedSignal,
    signalAsync("epicMerged", (payload) => {
      const result = applyEpicMergedToState(state, payload);
      handleMutationResult("epicMerged", result);
    }),
  );
  wf.setHandler(
    shellAddedSignal,
  ...
  wf.setHandler(
    ...
    signalAsync("changeRetargeted", (payload) => {
      const result = applyChangeRetargetedToState(state, payload);
      handleMutationResult("changeRetargeted", result);
    }),
  );
  wf.setHandler(
