...
function change(overrides: Partial<Change> = {}): Change { return { id: "example", title: "Example", status: "archived", created_at: "2026-01-01T00:00:00Z", created_by: "tester", tasks: [], deltas: {}, wisdom: [], gates: doneGates(), worker_bundle_impact: { kind: "not_applicable", rationale: "test" }, ...overrides }; }
